...
public class EmailCreateService {
    ...
    public void sendReservationEmail(Long userId, CreateReservationResponseDto responseDto) {
        ...
        String subject = String.format("%s님, %s 예매가 완료되었습니다.",
                user.getName(), responseDto.getPerformanceTitle());

        StringBuilder text = new StringBuilder();
        text.append(wrapWithH3("이름 : " + responseDto.getPerformanceTitle()))
                .append(wrapWithH3("일시 : " + responseDto.getRoundDate().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"))))
    ...
    public void sendPaymentEmail(Long userId, Payment payment) {
        ...
        String subject = String.format("%s님의 %s 결제가 완료되었습니다.",
                user.getName(), performance.getTitle());

        StringBuilder text = new StringBuilder();
        text.append(wrapWithH3("이름 : " + performance.getTitle()))
                .append(wrapWithH3("일시 : " + round.getDate().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"))))
