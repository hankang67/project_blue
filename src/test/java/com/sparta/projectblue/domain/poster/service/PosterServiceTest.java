...
public class PosterServiceTest {
    ...
    void setUp() {
        ...
        poster = new Poster(1L, "images/newPoster.jpg", "https://test-bucket.s3.amazonaws.com/oldPoster.jpg", 1024L);
    ...
    public void updatePosterTest() throws IOException {
        ...
        when(multipartFile.getInputStream()).thenReturn(new ByteArrayInputStream("mock data".getBytes()));
    ...
    public void updatePosterWhenS3UploadFails() throws IOException {
        ...
        ResponseStatusException exception = assertThrows(ResponseStatusException.class, () -> posterService.update(authUser, posterId, multipartFile));
