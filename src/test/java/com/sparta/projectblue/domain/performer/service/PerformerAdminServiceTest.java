...
public class PerformerAdminServiceTest {
    ...
    void 관리자권한이_없을_때_배우를_생성한다_예외처리() {
        ...
        CreatePerformerRequestDto request = new CreatePerformerRequestDto("심영식", "1990-08-15", "KOREA");
    ...
    void 생일_형식이_잘못되었을_때_예외처리() {
        // given
        AuthUser authUser = new AuthUser(1L, "admin@test.com", "adminUser", UserRole.ROLE_ADMIN);
        CreatePerformerRequestDto request = new CreatePerformerRequestDto("홍길동", "20241031", "KOREA");
    ...
    void 생일이_유효하지_않은_날짜일_때_예외처리() {
        // given
        AuthUser authUser = new AuthUser(1L, "admin@test.com", "adminUser", UserRole.ROLE_ADMIN);
        CreatePerformerRequestDto request = new CreatePerformerRequestDto("홍길동", "1800-01-01", "KOREA");
    ...
    void 관리자권한이_없을_때_배우_수정_예외처리() {
        // given
        AuthUser authUser = new AuthUser(1L, "user@test.com", "commonUser", UserRole.ROLE_USER);
        UpdatePerformerRequestDto request = new UpdatePerformerRequestDto("홍길동", "1990-01-01", "KOREA");
